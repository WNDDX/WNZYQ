...
const STATIC_ASSETS = [
  ...
  './assets/shop.css',
  './assets/shop.js',
  './assets/images/logo.png?v=178',
  './assets/images/kefu.png?v=178',
  './assets/images/qun.png?v=178',
  './assets/images/gzh.png?v=178'
];
