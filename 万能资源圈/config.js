 ...
 *
 *  部署到 Cloudflare 并完成"后台初始化"后，资源和分类以管理后台为准，
 *  在 admin.html 后台里增删改/显示隐藏即可，这个文件就不需要再改了。
 *
 *  【图片说明】
 *  - 仅 logo 用本地图片：assets/images/logo.png（替换这个文件即可）
 *  - 资源封面、详情图、类型图、视频都用网络 URL（https://...）
 *
 *  【价格说明】
 *  - price 字段：写了价格则显示，不写或 0 = 免费（免费不显示价格）
 *  - 类型也有 price：选中类型时显示类型价格，类型价格优先于资源价格
 *
 *  【描述超链接】
